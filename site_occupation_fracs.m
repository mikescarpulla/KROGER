...
% cs_num_sites_used - this is the matrix of integers telling how many of
...
tot_sites_occupied = cs_concs * defects.cs_num_sites_used;   % num each site is a num_cs x num_sites matrix, while cs_concs is a row vector.  
...
%     tot_sites_occupied(i) = dot(cs_concs, defects.cs_num_sites_used(:,i));
% end
