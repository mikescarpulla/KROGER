function [G0_Cr3O4_ls] = G0_Cr3O4_ls(T, P_tot, X_i, P_units)
%
...
mask1 = (T>298) .* (T<=2603);      % solid 

% solid
G0_Cr3O4_ls = mask1.*(-1479091.69 +1015.79091*T +2.663814450E-04*T.^(2) +1422428.90*T.^(-1) -1.338151100E-06*T.^(3) +1.236289250E-10*T.^(4) -174.543920*T.*log(T));
...
% % % 
% % % View Data  Cr3O4     Units:  T(K) P(atm) Energy(J) Quantity(mol) 
% % % Name: Chrome oxide
% % % 
% % %   G(T) J/mol - 1 atm  
% % % 
...
% % % 
% % % S1         1 - 1479091.69             + 1015.79091     T     + 2.663814450E-04 T^ 2 298 - 2603 
% % % S1         1 + 1422428.90     T^-1    - 1.338151100E-06 T^ 3 + 1.236289250E-10 T^ 4 298 - 2603 
% % % S1         1 - 174.543920     T ln(T)                                               298 - 2603 
% % % ____________ ________________________ ______________________ ______________________ __________ 
% % % 
