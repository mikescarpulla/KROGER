function [G0_CrO_ls] = G0_CrO_ls(T, P_tot, X_i, P_units)
%
...
mask1 = (T>298) .* (T<=1800);      % liquid
mask2 = (T>1800) .* (T<=2000);      

% liquid
G0_CrO_ls = mask1.*(-321531.193 +328.167001*T -1.368335050e-03*T.^(2) +772673.200*T.^(-1) +8912.35390*log(T) -2027.98876*T.^(0.5) -56.7277120*T.*log(T));
G0_CrO_ls = G0_CrO_ls + mask2.*(-312226.950 +355.301302*T -62.7600000*T.*log(T));
