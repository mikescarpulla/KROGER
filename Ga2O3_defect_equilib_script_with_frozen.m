...
[save_fname_root,save_pname] = uiputfile('*.*','Select or type the filename and location for saving results');
...
elements_save_fname = strcat(save_fname_root,'_element_totals');
...
conditions.fixed_defects_concentrations(163:169) = 0;   % VGa-2Sn and -3Sn
...
writecell(element_totals_cell,strcat(save_pname,equilib_save_fname),'Delimiter','tab','WriteMode','overwrite');
...
disp('Wrote equilibrium dark solution as text files')
