...
conditions.TRef = 300;
conditions.EgRef = 3.4;   % this is for constant Eg(T)
conditions.EvRef = 0;
...
conditions.Eg0 = 3.47;   % bandgap at 0K in eV.  Using Adrian's number from STEM EELS at PSU - 4.8 eV at 300 K.  So about 4.9 eV at 0K using
conditions.varshini_a = 9.39e-4;  % can implement any model you want for Eg(T) as long as it gives a value for all T_equilibrium
conditions.varshini_b = 772;
...
% site densities in the GaN lattice (num FU/unit cell / vol for unit cell)
N_Ga = 4.38e22;    %site 1
N_N = 4.38e22;  % site 2
N_iGa = 4.38e22;  %site 3
N_iN = 4.38e22;   %site 4
conditions.num_sites = [N_Ga; N_N; N_iGa; N_iN];   % note this needs to be a column vector, dont change it to a row vector
