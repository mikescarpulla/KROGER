...
conditions.T_equilibrium = 1500:-100:300;  % row vector of T in K at which to compute the equilirium
...
conditions.mu_GaN = -1.8;        % reasonable guess
...
% conditions.mu_conditions_flag = 'N2-1atm';
% conditions.mu_conditions_flag = 'air-1atm';
% conditions.mu_conditions_flag = 'N2 determined from NH3/H2 Equilibrium';
...
% if using "pN2-variable", need to also set pN2
% conditions.pN2 = 1;
% conditions.pN2 = 0.2;
% conditions.pN2 = 0.02;
% conditions.pN2 = 0.2*conditions.P_tot;  % for MOCVD
% conditions.pN2 = 1e-4;
% conditions.pN2 = 1e-6;
% conditions.pN2 = 1e-8;
...
%
if strcmp(conditions.mu_conditions_flag,'N2-1atm')   % equilibrium with N2 at pN2=ptot=1 atm.  This overrides anything you set accidentally above.
    conditions.pN2 = 1;
    conditions.p_tot = 1;
end
...
conditions.muT_equilibrium(:,1) = mu_Ga;  % these 3 lines not combined to keep it explicit that first 2 columns are Ga and N
conditions.muT_equilibrium(:,2) = mu_N;
...
% cond   % create  matrix of right size for ALL the elements - only will pay attention to those which are fixed
